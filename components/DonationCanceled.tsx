...
const DonationCanceled: React.FC = () => {
    ...
    <>
      ...
      <div className="relative min-h-screen font-sans flex items-center justify-center p-4">
        <div className="bg-white/80 backdrop-blur-lg rounded-lg shadow-xl p-8 max-w-lg text-center">
          <div className="mx-auto bg-blue-100 rounded-full w-20 h-20 flex items-center justify-center mb-6">
              <InformationCircleIcon className="w-12 h-12 text-blue-600" />
          </div>
          <h1 className="text-3xl font-bold text-slate-800 mb-3">{t('donationCanceledTitle')}</h1>
          <p className="text-slate-600 mb-8">{t('donationCanceledDesc')}</p>
          <a
            href="/"
