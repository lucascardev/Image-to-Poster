export default {
  ...
  "step3DescOverlap": "The <strong>striped blue area</strong> is a glue tab for easy assembly. Apply glue here and place the edge of the next page over it, aligning the images. This creates a strong and invisible seam.",
