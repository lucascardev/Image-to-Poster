...
export default {
  ...
  "step3DescOverlap": "Uma parte da imagem se repete nas páginas adjacentes para servir como <strong>guia de alinhamento</strong>. Aplique cola ou fita nesta área de sobreposição no verso de uma página e posicione a borda da página seguinte sobre ela, alinhando as imagens perfeitamente.",
