...
export default {
  ...
  "downloadGateTitle": "Seu Pôster Está Pronto!",
  "downloadGateSubtitle": "Aguarde alguns segundos enquanto preparamos o seu PDF.",
  "downloadGateWaiting": "Uma nova aba foi aberta. Aguarde o contador para liberar o download.",
  "downloadGateReady": "Pronto! Clique em Baixar Agora para obter seu pôster.",
  "downloadGateAdNotice": "Este site é gratuito graças ao apoio dos nossos parceiros. Obrigado por ajudar a manter o serviço disponível!",
  "downloadGateDownloadNow": "Baixar Agora",
  "downloadGateWaitBtn": "Aguarde",
  "cancel": "Cancelar",
