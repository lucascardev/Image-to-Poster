...
export default {
  ...
  "step3DescOverlap": "A <strong>área azul listrada</strong> é uma aba para colagem que facilita a montagem. Aplique cola nela e posicione a borda da página seguinte sobre ela, alinhando as imagens. Isso cria uma emenda forte e invisível.",
